    ...
    <div class="content">
        <form action="" id="tester-form" type="post">
            ...
            <div class="input-group submit">
                <button class="button" type="submit"><?php echo e(_wpcc('Test')); ?></button>
            </div>
        </form>
...
</div><?php /**PATH C:\wamp64\www\project-cms-b\wp-content\plugins\wp-content-crawler\app\views/site-tester/main.blade.php ENDPATH**/ ?>