...
<div class="wcc-settings-title">
    ...
    <span><?php echo e(_wpcc('Set main page URL, scheduling options, duplicate post checking, cookies...')); ?></span>
</div>
...
<table class="wcc-settings">
    ...
    <?php echo $__env->make('form-items.combined.multi-select-with-label', [
    ...
    ?>
    <?php echo $__env->make('form-items.combined.multi-checkbox-with-label', array_merge([
        ...
        'info'  =>  _wpcc('Set how to decide whether a post is duplicate or not. Duplicate checking will be
            ...
            duplicate.')
    ], $duplicatePostViewOptions), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php echo $__env->make('form-items.combined.multiple-key-value-with-label', [
    ...
    <?php echo $__env->make('partials.table-section-title', ['title' => _wpcc("Settings Page")], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH C:\wamp64\www\project-cms-b\wp-content\plugins\wp-content-crawler\app\views/site-settings/tab-main.blade.php ENDPATH**/ ?>