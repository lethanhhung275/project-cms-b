<div class="input-group find-replace <?php echo e(isset($addon) ? 'addon' : ''); ?> <?php echo e(isset($remove) ? 'remove' : ''); ?>"
    ...
    <?php endif; ?>
</div><?php /**PATH C:\wamp64\www\project-cms-b\wp-content\plugins\wp-content-crawler\app\views/form-items/find-replace.blade.php ENDPATH**/ ?>