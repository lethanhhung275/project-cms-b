...
<?php $__env->startSection('content'); ?>
    ...
    <div class="table-container hidden">
        ...
        <div class="control-buttons">
            ...
            <button class="button pause" type="button" title="<?php echo e(_wpcc('Pause crawling')); ?>">
            ...
            <button class="button continue hidden" type="button" title="<?php echo e(_wpcc('Continue crawling')); ?>">
        ...
        <table id="table-url-queue-manual-crawl">
            ...
            <tr class="prototype url hidden">
                ...
                <td class="controls">
                    ...
                    <button class="button repeat" type="button" title="<?php echo e(_wpcc("Retry/recrawl")); ?>">
                        <span class="dashicons dashicons-controls-repeat"></span>
                    </button>

                    
                    <button class="button delete" type="button" title="<?php echo e(_wpcc("Delete")); ?>">
...
<?php echo $__env->make('tools.base.tool-container', [
    ...
    'noToggleButton'    => true
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\project-cms-b\wp-content\plugins\wp-content-crawler\app\views/tools/partials/component-urls.blade.php ENDPATH**/ ?>