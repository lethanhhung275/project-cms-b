...
<?php if(!isset($max) || $max != 1): ?>
    ...
    <div class="actions">
        ...
        <?php if($showExport): ?>
            <button class="button setting-export"><?php echo e(_wpcc('Export')); ?></button>
        <?php endif; ?>

        <?php if($showImport): ?>
            <button class="button setting-import"><?php echo e(_wpcc('Import')); ?></button>
        <?php endif; ?>
    </div>
...
<?php endif; ?><?php /**PATH C:\wamp64\www\project-cms-b\wp-content\plugins\wp-content-crawler\app\views/form-items/multiple.blade.php ENDPATH**/ ?>