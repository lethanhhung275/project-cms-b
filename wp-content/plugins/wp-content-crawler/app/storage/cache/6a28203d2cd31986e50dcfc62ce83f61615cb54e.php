<div class="input-group product-name-selector-attribute <?php echo e(isset($addon) ? 'addon dev-tools' : ''); ?> <?php echo e(isset($remove) ? 'remove' : ''); ?>"
    ...
    <?php endif; ?>
</div><?php /**PATH C:\wamp64\www\project-cms-b\wp-content\plugins\wp-content-crawler\app\views/post-detail/woocommerce/form-items/product-name-selector-with-attribute.blade.php ENDPATH**/ ?>