<?php if(isset($template)): ?>
    <div class="details">
        <h2>
            ...
            <?php endif; ?>
            <button class="button" id="go-to-details"><?php echo e(_wpcc('Go to details')); ?></button>
        </h2>
        <div class="inside">
            <div class="template">
                <?php echo $template; ?>
...
</div><?php /**PATH C:\wamp64\www\project-cms-b\wp-content\plugins\wp-content-crawler\app\views/site-tester/test-results.blade.php ENDPATH**/ ?>