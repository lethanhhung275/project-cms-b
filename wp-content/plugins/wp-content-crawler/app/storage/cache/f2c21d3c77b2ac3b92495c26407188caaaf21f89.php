<div class="input-group selector-custom-product-attribute <?php echo e(isset($addon) ? 'addon dev-tools' : ''); ?> <?php echo e(isset($remove) ? 'remove' : ''); ?>"
    ...
    <?php endif; ?>
</div><?php /**PATH C:\wamp64\www\project-cms-b\wp-content\plugins\wp-content-crawler\app\views/post-detail/woocommerce/form-items/selector-custom-product-attribute.blade.php ENDPATH**/ ?>